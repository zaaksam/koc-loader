...
var rewriterInjectRE = /\b((css|(ko-)?html)(-loader)?(\?[^!]+)?)(?:!|$)/
var rewriters = {
...
module.exports = function (content) {
  ...
  var options = Object.assign({}, this.options.ko, this.ko, query)
  ...
  var output = 'var __ko_script__, __ko_template__\n' +
    'var __ko_styles__ = {}\n'
  ...
  function setCssModule(style, require) {
    ...
    return '__ko_styles__["' + style.module + '"] = ' + require + '\n'
  }
  ...
  if (parts.script.length) {
    ...
    if (!this.minimize) {
      output +=
        'if (__ko_script__ &&\n' +
        '    __ko_script__.__esModule &&\n' +
        '    Object.keys(__ko_script__).length > 1) {\n' +
        '  console.warn(' + JSON.stringify(
          '[ko-loader] ' + path.relative(process.cwd(), filePath) +
          ': named exports in *.ko files are ignored.'
        ) + ')' +
        '}\n'
    }
  }
  ...
  output += 'if (__ko_script__ && __ko_script__.__esModule) {\n' +
    '  __ko_script__ = __ko_script__[\'default\']\n' +
    '}\n' +
    'var Component = {\n' +
    '  viewModel: function (params) {\n' +
    '    return new __ko_script__(params)\n' +
    '  },\n' +
    '  template: __ko_template__\n' +
    '}\n'
